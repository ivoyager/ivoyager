...
func _project_init() -> void:
	...
	for row in IVTableData.get_n_rows("visual_groups"):
		var body_flag := IVTableData.get_int("visual_groups", "body_flag", row)
		var name_visible := IVTableData.get_bool("visual_groups", "default_name_visible", row)
		var symbol_visible := IVTableData.get_bool("visual_groups", "default_symbol_visible", row)
		var orbit_visible := IVTableData.get_bool("visual_groups", "default_orbit_visible", row)
		var orbit_color_str := IVTableData.get_string("visual_groups", "default_orbit_color", row)
