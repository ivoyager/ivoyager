...
enum BodyFlags {
	...
	CHAOTIC_ROTATION = 0b1000000 * 0x10000,
	VARIABLE_AXIAL_TILT = 0b10000000 * 0x10000,
	IS_NAVIGATOR_MOON = 0b1 * 0x1000000, # show in system navigator
	LIKELY_HYDROSTATIC_EQUILIBRIUM = 0b10 * 0x1000000, # for moon orbit color
	DISPLAY_M_RADIUS = 0b100 * 0x1000000,
	HAS_ATMOSPHERE = 0b1000 * 0x1000000,
